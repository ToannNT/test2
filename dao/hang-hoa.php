...
// function sach_top_3()
// {
//     $sql = "SELECT * FROM sach ORDER BY dac_biet DESC";
//     return pdo_query($sql);
// }


function get_dssp_giacao()
{
    $sql = "SELECT * FROM xedap WHERE gia > 1000000 ORDER BY id DESC LIMIT 3";
    return pdo_query($sql);
}

function get_dssp_khuyenmai()
{
    $sql = "SELECT * FROM xedap WHERE giam_gia >0 ORDER BY id DESC";
    return pdo_query($sql);
}
